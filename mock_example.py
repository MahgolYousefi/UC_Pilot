...
finance_options = {
        ...
        "Q3": {"a": ( "Shift a portion to more conservative investments, such as bonds, to mitigate risk", -1),
               "b": ("Rebalance to maintain original asset allocation and risk profile", "Q9", +2),
               "c": ("Identify and invest in stocks that may now be undervalued" "Q10", +1)},
        "Q4": {"a": ("Focus on the potential returns not risks", -1),
        ...
        "Q6": {"a": ("Increase allocations to inflation-resistant assets like real estate and commodities", "Q17", +2),
               "b": ("Convert a portion of investments to cash to manage potential market downturns", -1),
               "c": ("Adjust investment ratios subtly while monitoring economic indicators closely", "Q19", +1)},
        "Q7": {"a": ("Utilize a savings plan like a 529 that provides tax advantages and educational expense flexibility", "Q20", +2),
               "b": ("Allocate a portion of investments into mutual funds specifically designated for educational purposes", "Q21", +1),
               "c": ("Plan on leveraging scholarships and student loans to cover educational costs", -1)},
        ...
        "Q11": {"a": ("Establish a trust to protect assets and minimize taxes", "Q12", +2),
                ...
                "c": ("Incorporate life insurance to manage future tax burdens on assets", "Q14", +1)},
...
health_options = {
    "Q1": {"a": ("Biological predispositions that affect metabolic rates", "Q2", +1),
           "b": ("Changes in lifestyle patterns that reduce physical activity", "Q3", -1),
    ...
    "Q2": {"a": ("Body Mass Index (BMI), a common standard for categorizing weight relative to height", "Q5", +2),
           "b": ("Waist-to-hip ratio, which assesses fat distribution and potential risk", "Q6", +1),
           "c": ("Body fat percentage, a direct measure of body composition", "Q7", +1)},
    "Q3": {"a": ("5% of total body weight", "Q8", -1),
           "b": ("10% of total body weight", "Q9", +2),
           "c": ("15% of total body weight", "Q10", +1)},
    "Q4": {"a": ("Personal discipline issues, including consistency in diet and exercise", "Q11", -1),
           "b": ("Genetic predispositions that influence metabolic rate and fat storage", "Q12", +2),
           "c": ("Environmental factors, such as availability of and access to healthy food options", "Q13", +1)},
    "Q5": {"a": ("Proteins, which are vital for muscle repair and growth", "Q14", -1),
           "b": ("Fats, necessary for hormone production and nutrient absorption", "Q15", +2),
           "c": ("Carbohydrates, main source of energy for daily activities", "Q16", +1)},
    "Q6": {"a": ("Increased food availability", "Q17", +2),
           "b": ("Economic factors", "Q18", -1),
           "c": ("Technological advancements", "Q19", +1)},
    "Q7": {"a": ("Following fad diets", "Q20", +2),
           "b": ("Caloric restriction", "Q21", -1),
           "c": ("Sustainable lifestyle changes", "Q22", +1)},
    "Q8": {"a": ("Setting realistic goals", "Q23", +2),
           "b": ("Seeking professional advice", "Q24", +1),
           "c": ("Committing to a fitness facility", "Q25", -1)},
    "Q9": {"a": ("Emotional overeating", "Q26", +2),
           "b": ("Sleep deprivation", "Q27", -1),
           "c": ("Interpersonal tensions", "Q28", +1)},
    "Q10": {"a": ("70% genetic influence", "Q29", -1),
            "b": ("50% genetic influence", "Q30", +1),
            "c": ("30% genetic influence", "Q25", +2)},
    "Q11": {"a": ("High-intensity steady-state cardio", "Q12", 11),
            "b": ("High-intensity interval training", "Q13", +2),
            "c": ("Weight training", +1)},
    "Q12": {"a": ("Maintain a baseline of at least 2 liters per day, potentially increasing based on factors like physical activity and overall health", "Q14", +2),
    ...
    "Q14": {"a": ("Focus primarily on increasing the intake of omega-9 monounsaturated fats, such as those found in olive oil", "Q18", -1),
            "b": ("Limit all forms of dietary fats significantly to reduce calorie intake and prevent fat accumulation", "Q19", +1),
            "c": ("Balance the intake of omega-3 and omega-6 polyunsaturated fats, ensuring a higher proportion of omega-3s from sources like fish and flaxseed", "Q20", +2)},
    "Q15": {"a": ("It accelerates the metabolism, leading to rapid weight loss", "Q21", +1),
            "b": ("It supports digestive health, promoting satiety and regular bowel movements", "Q22", +2),
            "c": ("It enhances nutrient absorption, ensuring efficient use of consumed calories", -1)},
    "Q16": {"a": ("By reducing overall caloric intake", "Q23", +2),
            "b": ("By increasing energy expenditure", "Q24", +1),
            "c": ("By improving metabolic flexibility", -1)},
    "Q17": {"a": ("Emphasizing the quality of food consumed is more important than the quantity for sustainable weight loss", "Q25", -1),
            "b": ("Effective dieting primarily revolves around strict calorie restriction regardless of nutritional value", +2),
    ...
    "Q18": {"a": ("Adopting a fixed calorie limit", "Q26", -1),
            "b": ( "Integrating a balance of macronutrients and permit occasional indulgences", "Q27", +2),
    ...
    "Q20": {"a": ("Creating a system of small, frequent rewards to maintain motivation", "Q12", -1),
            "b": ("Establishing a reliable support network for encouragement and accountability",
 "Q13", +2),
    ...
    "Q22": {"a": ("Joining a weight loss clinic", "Q16", -1),
            "b": ("Starting with light exercise", "Q17", +2),
            "c": ("Starting with cutting all sugars", +1)},
    "Q23": {"a": ("They are preferred as an initial treatment option", "Q18", -1),
